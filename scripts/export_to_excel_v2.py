...
data = [
    ["카테고리", "메서드", "API 경로", "설명", "요청 파라미터 (Body/Query)", "응답 데이터 (JSON 예시)"],
...
col_widths = {'A': 15, 'B': 10, 'C': 40, 'D': 35, 'E': 40, 'F': 50}
for col, width in col_widths.items():
    ws.column_dimensions[col].width = width

wb.save(filepath)
print("Excel file with JSON responses generated successfully!")
